...
public extension NQBanner {
    ...
    static func error(_ message: String) -> NQBanner {
        NQBanner(message, dotColor: NQTheme.warning.darkened(0.2))
    }
}
            ...
            .overlay {
                if selected {
                    RoundedRectangle(cornerRadius: NQTheme.radiusM)
                        ...
                        .shadow(color: color.opacity(0.6), radius: pulsing && !reduceMotion ? 10 : 4)
                        .animation(
