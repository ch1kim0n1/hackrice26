...
struct RarityAnimationConfiguration {
    ...
    var hasEffects: Bool { auraEnabled || glowEnabled }
    ...
    static func configuration(for rarity: Rarity) -> Self {
        ...
        case .common, .uncommon:
            return Self()
        case .rare:
            return Self(glowColor: NQRarity.rare.outline, glowOpacity: 0.30...0.50)
        case .epic:
        ...
        case .legendary:
            return Self(aura: .gold, auraFPS: 18, auraScale: 1.20, auraOpacity: 0.72,
                        ...
                        accentInterval: 7.5, accentStrength: 0.12)
        case .mythic:
            return Self(aura: .red, auraFPS: 20, auraScale: 1.28, auraOpacity: 0.78,
                        ...
                        accentStrength: 0.20, secondaryAura: .flame)
        case .secret:
            return Self(aura: .smoke, auraFPS: 15, auraScale: 1.30, auraOpacity: 0.92,
                        ...
                        accentInterval: 10.5, accentDuration: 1.8, accentStrength: 0.12)
        }
    }
