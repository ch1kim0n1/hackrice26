...
final class HealthKitManager {
    ...
    /// Only the types the game actually reads. Requesting more would be
    /// asking players for data we never use.
    ...
    func fetchCurrentSnapshot() async throws -> HealthKitSnapshot {
        guard isHealthDataAvailable else { throw HealthKitError.notAvailable }
